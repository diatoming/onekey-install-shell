...
program_version_link="https://raw.githubusercontent.com/diatoming/onekey-install-shell/master/frps/version.sh"
str_install_shell=https://raw.githubusercontent.com/diatoming/onekey-install-shell/master/frps/install-frps.sh
shell_update(){
    fun_diatoming "clear"
